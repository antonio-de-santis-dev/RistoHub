...
describe('Prodotto Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '0e2c6771-3027-41d7-a534-418de56ec373' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'b535ea01-d7dd-4cfe-9ddf-1777df7d8ada' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.prodottos()[0]).toEqual(expect.objectContaining({ id: '0e2c6771-3027-41d7-a534-418de56ec373' }));
  });
