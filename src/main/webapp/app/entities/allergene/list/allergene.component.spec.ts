...
describe('Allergene Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '35dfa8eb-a96b-443f-a11e-87b8a1f107d3' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '7916bb91-6f33-42b1-a04f-81d88b92555e' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.allergenes()[0]).toEqual(expect.objectContaining({ id: '35dfa8eb-a96b-443f-a11e-87b8a1f107d3' }));
  });
